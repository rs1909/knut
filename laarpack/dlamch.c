...
doublereal
dlamch_ (char *cmach, ftnlen cmach_len)
{
	/* Initialized data */
...
static int
dlamc1_ (integer * beta, integer * t, logical * rnd, logical * ieee1)
{
	/* Initialized data */
...
static int
dlamc2_ (integer * beta, integer * t, logical * rnd, doublereal * eps, integer * emin, doublereal * rmin, integer * emax, doublereal * rmax)
{
	/* Initialized data */
	...
	static char fmt_9999[] = "(//\002 WARNING. The value EMIN may be incorre"
		...
		" the IF block as marked within the code of routine\002,\002 DLAM" "C2,\002,/\002 otherwise supply EMIN explicitly.\002,/)";
	...
	/* Fortran I/O blocks */
	static cilist io___381 = { 0, 6, 0, fmt_9999, 0 };
...
static doublereal
dlamc3_ (doublereal * a, doublereal * b)
{
	/* System generated locals */
	doublereal ret_val;
...
static int
dlamc4_ (integer * emin, doublereal * start, integer * base)
{
	/* System generated locals */
	integer i__1;
	doublereal d__1;
...
static int
dlamc5_ (integer * beta, integer * p, integer * emin, logical * ieee, integer * emax, doublereal * rmax)
{
	/* System generated locals */
	integer i__1;
	doublereal d__1;
