...
It is possible to convert the solution profile from DDE-BIFTOOL to this format and back. For this use the matlab scripts \filef{dde2pdde.m} or \filef{pdde2pdd.m} in the \filef{matlab} subdirectory in the following way. Assume that there is branch of periodic solutions (\funp{psbr}). This branch can be exported using the command
