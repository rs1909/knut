...
class TestFunctCPLX : public baseTestFunct
{
	public:
		...
		double Funct( NColloc&, const Vector&, const Vector&, const JagMatrix3D&) { return 0.0; }
		double Funct_p( NColloc&, const Vector&, const Vector&, const JagMatrix3D&, int) { return 0.0; }
