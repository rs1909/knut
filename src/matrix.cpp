...
void Matrix::AX( double* X, const double* B, const double alpha, bool trans ) const
{
	if( alpha == 1.0 )
	{
		if( !trans )
...
void Matrix::AXpY( double* X, const double* B, const double* C, double alpha, double beta, bool trans ) const 
{
	if( alpha == 1.0 )
	{
		if( !trans )
...
void Matrix::AX( Matrix& X, const Matrix& B, double alpha, bool trans ) const 
{
	if( !trans ){ if( (this->r != X.Row()) || (this->c != B.Row()) ) { cout<<"Matrix::AX_M : Bad dimensions"; return; } }
	else if( (this->c != X.Row()) || (this->r != B.Row()) ) { cout<<"Matrix::AX_M : Bad dimensions"; return; }
	if( X.Col() != B.Col() ) { cout<<"Matrix::AX_M : Bad dimensions 2"; return; }
...
void Matrix::AXpY( Matrix& X, const Matrix& B, const Matrix& C, double alpha, double beta, bool trans ) const 
{
	if( !trans ){ if( (this->r != X.Row()) || (this->c != B.Row()) ) { cout<<"Matrix::AXpY_M : Bad dimensions"; return; } }
	else if( (this->c != X.Row()) || (this->r != B.Row()) ) { cout<<"Matrix::AXpY_M : Bad dimensions"; return; }
	if( X.Col() != B.Col() ) { cout<<"Matrix::AXpY_M : Bad dimensions 2"; return; }
