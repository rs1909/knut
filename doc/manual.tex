...
{\bf \large Revision history } \vskip 0.25em
  \begin{tabular}{ |l|c|l| }
    ...
    \hline July 2005 -- Sept. 2005 & 0.9.9 -- & N.A. \\
    \hline
  \end{tabular}
\end{center}
...
It is used only when constructing a starting point for bifurcation continuation. (Same as \funp{I0}.)
\item[\funp{S17} -] The argument of the characteristic multiplier, when a Neimark-Sacker bifurcation is continued. (Same as \funp{I1}.)
