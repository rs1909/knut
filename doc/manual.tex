...
%
\item[\funp{1} -] Continuation of fold bifurcations in two parameters (1)
%
...
%
\item[\funp{5} -] Switches to the other solution at a branching point and follows the orbits (0)
\end{description}
Similarly in the case of autonomous systems:
\begin{description}
\item[\funp{10} -] Continuation of periodic solutions (1)
%
...
%
\item[\funp{EPSR}] ~\\
Tolerance in the refinement of solutions. (Solution refinement is used only before continuation starts.) It shold be less than or equal to \funp{EPSC}.
%
\item[\funp{EPSS}] ~\\
